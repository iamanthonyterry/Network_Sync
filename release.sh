...
# Usage: ./release.sh 0.0.9-alpha
# Github Release push: 
#  gh release create v0.0.9-alpha build/NetworkSync-0.0.9-alpha.zip build/appcast.xml --title "0.0.9-alpha" --notes "Ninth alpha release"
