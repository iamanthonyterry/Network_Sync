...
# Usage: ./release.sh 0.0.3-alpha
# Github Release push: 
#  gh release create v0.0.3-alpha build/NetworkSync-0.0.3-alpha.zip build/appcast.xml --title "0.0.3-alpha" --notes "Third alpha release"
